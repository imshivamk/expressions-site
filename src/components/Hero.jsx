...
const Hero = () => {
  const [date, setDate] = useState(new Date(1770458400000 - currDate));
  ...
  return (
    ...
    >
      ...
      <div className="bg-black/60 p-5 w-full">
        {/* Abstract Shapes */}
        ...
        text-indigo-100 mb-8 font-semibold">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <button onClick={() => window.location.href = "https://docs.google.com/forms/d/e/1FAIpQLSddnW3rdwo-u4u7LIf5i_jAu3dQbBRH76M6Q1RDuor_2Mj4AA/viewform?pli=1"} className="bg-white text-indigo-900 font-bold py-3 px-8 rounded-full shadow-lg transform transition hover:scale-105 hover:shadow-xl">
              Register Now
            </button>
            <button onClick={() => window.location.href = "https://qr.scan.page/uploads/pdf/NdnFm1_6bf5ebd94b5cd184.pdf"}
              className="border-2 border-white/30 bg-gray-600/40 backdrop-blur-sm text-white font-semibold py-3 px-8 rounded-full hover:bg-white/10 transition">
              View Rulebook
            </button>
          </div>
